package br.com.trmasolucoes.testelocationapi.network;
...
public class HttpConnection {
    ...
    public static String getSetDataWeb(String url, String method, LatLng l, double distance){
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost(url);
        String answer = "";
        ...
        try{
            ArrayList<NameValuePair> valores = new ArrayList<NameValuePair>();
            valores.add(new BasicNameValuePair("method", method));
            valores.add(new BasicNameValuePair("latitude", l.latitude+"" ));
            valores.add(new BasicNameValuePair("longitude", l.longitude+"" ));
            valores.add(new BasicNameValuePair("distance", distance+"" ));
