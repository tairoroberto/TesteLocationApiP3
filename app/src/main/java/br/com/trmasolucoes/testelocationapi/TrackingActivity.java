...
import br.com.trmasolucoes.testelocationapi.domain.MessageEB;
import br.com.trmasolucoes.testelocationapi.domain.Place;
import br.com.trmasolucoes.testelocationapi.network.HttpConnection;
import br.com.trmasolucoes.testelocationapi.service.JobSchedulerService;
        ...
        private static class MyAsyncTaskPlaces extends AsyncTask<Void, Void, List<Place>> {
            ...
            protected List<Place> doInBackground(Void... params) {
                ...
                if (weakReference.get() != null) {
                    ...
                    double latitude = Double.parseDouble( getInSharedPreferences(weakReference.get(), weakReference.get().LATITUDE_KEY, "-23.42179631") );
                    double longitude = Double.parseDouble( getInSharedPreferences(weakReference.get(), weakReference.get().LONGITUDE_KEY, "-46.65946126") );
                    LatLng latLng = new LatLng(latitude, longitude);
